...
public class MasterGatewayIntegrationTest {
    ...
    public void setup() throws Exception {
        gateway = new MasterGateway("10.182.5.216", 1337);
    }

    @Test
    @Category(IntegrationTest.class)
    public void registerClientTest() {
        HanRoutingProtocol.ClientRegisterResponse response = gateway.testRegisterClient("banaan", "Koen", "abcde12345");
    ...
    public void updateGraphTest() {
        HanRoutingProtocol.GraphUpdateResponse response = gateway.testGraphUpdate(10, "abcde12345");
    ...
    public void registerNodeTest() {
        HanRoutingProtocol.NodeRegisterResponse response = gateway.testRegisterNode("192.168.0.0", 80, "12345abcde");
    ...
    public void updateNodeTest() {
        HanRoutingProtocol.NodeUpdateResponse response = gateway.testUpdateNode("2", "56857cfc709d3996f057252c16ec4656f5292802", "192.170.0.1", 90, "abcde12345");
    ...
    public void deleteNodeTest() {
        HanRoutingProtocol.NodeDeleteResponse response = gateway.testDeleteNode("2", "56857cfc709d3996f057252c16ec4656f5292802", "abcde12345");
    ...
    public void getClients() {
        HanRoutingProtocol.ClientResponse response = gateway.testGetClients(10, "abcde12345");
