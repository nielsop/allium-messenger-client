...
public class Parser {
     ...
     *          does not contain a valid {@link HanRoutingProtocol} instance
     */
    public static GeneratedMessage parseFrom(byte[] message, Class<? extends GeneratedMessage> targetClass)
            throws InvalidProtocolBufferException {
        Check.notNull(message, "message");
        Check.notNull(targetClass, "targetClass");

        try {
            return (GeneratedMessage) targetClass.getMethod("parseFrom", byte[].class).invoke(null, message);
