...
public class HyperSQLDatabase implements IDatabase {
    ...
    public void initializeDatabase() throws SQLException {
        ...
        query("CREATE TABLE IF NOT EXISTS Message (id INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1), sender VARCHAR(256), receiver (VARCHAR256), timestamp TIMESTAMP,  message NVARCHAR(1024), PRIMARY KEY(id))");
    }
